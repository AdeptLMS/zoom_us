  ...
  module Models
    class InlineResponse20090
      ...
      def self.swagger_types
        {
          ...
          :'call_queues' => :'Array<InlineResponse20090CallQueues>'
        }
      end
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'call_queues')
          if (value = attributes[:'call_queues']).is_a?(Array)
            self.call_queues = value
          end
        end
      end
      ...
      def hash
        [page_size, next_page_token, total_records, call_queues].hash
      end
