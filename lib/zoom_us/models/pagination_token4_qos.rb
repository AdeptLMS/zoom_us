  ...
  module Models
    ...
    class PaginationToken4Qos
      ...
      def list_invalid_properties
        ...
        if !@page_size.nil? && @page_size > 10
          invalid_properties.push('invalid value for "page_size", must be smaller than or equal to 10.')
        end
      ...
      def valid?
        return false if !@page_size.nil? && @page_size > 10
        true
      end
      ...
      def page_size=(page_size)
        if !page_size.nil? && page_size > 10
          fail ArgumentError, 'invalid value for "page_size", must be smaller than or equal to 10.'
        end
      ...
      def hash
        [page_count, page_size, total_records, next_page_token].hash
      end
