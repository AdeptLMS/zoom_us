...
module ZoomUs
  module Models
    class InlineResponse2002Rooms
      ...
      def valid?
        status_validator = EnumAttributeValidator.new('String', ['Offline', 'Available', 'InMeeting', 'UnderConstruction'])
      ...
      def status=(status)
        validator = EnumAttributeValidator.new('String', ['Offline', 'Available', 'InMeeting', 'UnderConstruction'])
      ...
      def hash
        [id, name, activation_code, status].hash
      end
