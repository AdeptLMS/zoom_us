  ...
  module Models
    ...
    class BillingContactRequired
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'apt')
          self.apt = attributes[:'apt']
        end
      ...
      def hash
        [first_name, last_name, email, phone_number, address, apt, city, state, zip, country].hash
      end
