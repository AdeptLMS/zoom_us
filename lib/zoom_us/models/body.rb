...
module ZoomUs
  module Models
    class Body
      ...
      # Custom attribute writer method with validation
      # @param [Object] registration_expire_time Value to be assigned
      ...
      # Custom attribute writer method with validation
      # @param [Object] authorization_name Value to be assigned
      ...
      def user_email=(user_email)
        ...
        if user_email.to_s.length > 64
          fail ArgumentError, 'invalid value for "user_email", the character length must be smaller than or equal to 64.'
        end
      ...
      # Custom attribute writer method with validation
      # @param [Object] voice_mail Value to be assigned
