...
module ZoomUs
  module Models
    ...
    class InlineResponse20061
      ...
      # The status of the user.<br> `activate`: An active user. <br> `deactivate`: User has been deactivated from the ZoomPhone system.
      attr_accessor :status

      # Unique Identifier for a [site](https://support.zoom.us/hc/en-us/articles/360020809672).
