...
module ZoomUs
  module Models
    class InlineResponse20034
      ...
      attr_accessor :total_meeting_minutes

      # Number of meetings for this range.
      attr_accessor :total_meetings
      ...
      def self.swagger_types
        {
          ...
          :'users' => :'Array<InlineResponse20034Users>'
        }
      end
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'total_meeting_minutes')
          self.total_meeting_minutes = attributes[:'total_meeting_minutes']
        end

        if attributes.has_key?(:'total_meetings')
          self.total_meetings = attributes[:'total_meetings']
        end

        if attributes.has_key?(:'total_participants')
      ...
      def ==(o)
        ...
        self.class == o.class &&
          ...
          to == o.to &&
          total_meeting_minutes == o.total_meeting_minutes &&
          total_meetings == o.total_meetings &&
      ...
      def hash
        [from, page_count, page_number, page_size, to, total_meeting_minutes, total_meetings, total_participants, total_records, users].hash
      end
