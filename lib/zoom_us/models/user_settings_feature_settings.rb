...
module ZoomUs
  module Models
    ...
    class UserSettingsFeatureSettings
      ...
      attr_accessor :webinar_capacity
      ...
      def hash
        [meeting_capacity, large_meeting, large_meeting_capacity, webinar, webinar_capacity, cn_meeting, in_meeting, zoom_phone].hash
      end
