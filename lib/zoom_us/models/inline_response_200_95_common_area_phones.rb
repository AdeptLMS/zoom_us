...
module ZoomUs
  module Models
    class InlineResponse20095CommonAreaPhones
      ...
      def self.swagger_types
        {
          ...
          :'device_type' => :'String',
          :'mac_address' => :'String',
          :'calling_plans' => :'Array<InlineResponse20095CallingPlans>',
          :'phone_numbers' => :'Array<InlineResponse20095PhoneNumbers>',
          :'status' => :'String',
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'calling_plans')
          if (value = attributes[:'calling_plans']).is_a?(Array)
            self.calling_plans = value
          end
        end
      ...
      def hash
        [id, display_name, device_type, mac_address, calling_plans, phone_numbers, status, site].hash
      end
