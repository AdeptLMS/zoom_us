...
module ZoomUs
  module Models
    ...
    class AccountSettingsIntegration
      ...
      attr_accessor :microsoft_one_drive
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'google_calendar')
          self.google_calendar = attributes[:'google_calendar']
        end

        if attributes.has_key?(:'google_drive')
          self.google_drive = attributes[:'google_drive']
        end

        if attributes.has_key?(:'dropbox')
          self.dropbox = attributes[:'dropbox']
        end

        if attributes.has_key?(:'box')
          self.box = attributes[:'box']
        end

        if attributes.has_key?(:'microsoft_one_drive')
          self.microsoft_one_drive = attributes[:'microsoft_one_drive']
        end

        if attributes.has_key?(:'kubi')
          self.kubi = attributes[:'kubi']
        end
      end
      ...
      def ==(o)
        ...
        self.class == o.class &&
          ...
          dropbox == o.dropbox &&
          box == o.box &&
          microsoft_one_drive == o.microsoft_one_drive &&
          kubi == o.kubi
      end
      ...
      def hash
        [google_calendar, google_drive, dropbox, box, microsoft_one_drive, kubi].hash
      end
