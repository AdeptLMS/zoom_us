  ...
  module Models
    ...
    class InlineResponse20063
      ...
      def self.swagger_types
        {
          ...
          :'call_logs' => :'Array<InlineResponse20063CallLogs>'
        }
      end
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'call_logs')
          if (value = attributes[:'call_logs']).is_a?(Array)
            self.call_logs = value
          end
        end
      end
      ...
      def hash
        [from, to, page_count, page_number, page_size, total_records, call_logs].hash
      end
