...
module ZoomUs
  module Models
    class InlineResponse20097BlockedList
      ...
      # Block type.<br> `inbound`: The blocked number or numbers with the specifie prefix are prevented from calling in to phone users.<br><br> `outbound`: The phone users  are prevented from calling the blocked number or numbers with the specified prefix.
      attr_accessor :block_type

      # Indicates whether the blocking is active or inactive. <br> `active`: The blocked list is active.<br> `inactive`: The blocked list is inactive.
      ...
      def hash
        [id, match_type, phone_number, block_type, status, comment].hash
      end
