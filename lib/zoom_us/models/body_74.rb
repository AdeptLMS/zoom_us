  ...
  module Models
    class Body74
      ...
      def list_invalid_properties
        ...
        if @extension_number.nil?
          invalid_properties.push('invalid value for "extension_number", extension_number cannot be nil.')
        end
        ...
        if !@model.nil? && @model.to_s.length < 1
          invalid_properties.push('invalid value for "model", the character length must be great than or equal to 1.')
        end
      ...
      def valid?
        ...
        return false if @extension_number.nil?
      ...
      def model=(model)
        ...
        if !model.nil? && model.to_s.length < 1
          fail ArgumentError, 'invalid value for "model", the character length must be great than or equal to 1.'
        end
      ...
      def hash
        [site_id, display_name, description, extension_number, mac_address, type, model, time_zone].hash
      end
