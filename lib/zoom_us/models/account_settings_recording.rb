...
module ZoomUs
  module Models
    ...
    class AccountSettingsRecording
      ...
      attr_accessor :cloud_recording_download

      # Only the host can download cloud recordings.
      attr_accessor :cloud_recording_download_host
      ...
      attr_accessor :account_user_access_recording
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'cloud_recording_download')
          self.cloud_recording_download = attributes[:'cloud_recording_download']
        end

        if attributes.has_key?(:'cloud_recording_download_host')
          self.cloud_recording_download_host = attributes[:'cloud_recording_download_host']
        end

        if attributes.has_key?(:'account_user_access_recording')
          self.account_user_access_recording = attributes[:'account_user_access_recording']
        end
      ...
      def ==(o)
        ...
        self.class == o.class &&
          ...
          cloud_recording_download == o.cloud_recording_download &&
          cloud_recording_download_host == o.cloud_recording_download_host &&
          account_user_access_recording == o.account_user_access_recording &&
      ...
      def hash
        [local_recording, cloud_recording, record_speaker_view, record_gallery_view, record_audio_file, save_chat_text, show_timestamp, recording_audio_transcript, auto_recording, cloud_recording_download, cloud_recording_download_host, account_user_access_recording, auto_delete_cmr, auto_delete_cmr_days].hash
      end
