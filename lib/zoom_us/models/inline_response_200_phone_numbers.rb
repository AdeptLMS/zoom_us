...
module ZoomUs
  module Models
    class InlineResponse200PhoneNumbers
      ...
      # The type of number. Values can be one of the following:<br> `toll`, `tollfree`
      ...
      def status=(status)
        validator = EnumAttributeValidator.new('String', ['pending', 'available'])
      ...
      def number_type=(number_type)
        validator = EnumAttributeValidator.new('String', ['toll', 'tollfree'])
