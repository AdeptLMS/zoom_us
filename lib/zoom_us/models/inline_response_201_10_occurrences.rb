...
module ZoomUs
  module Models
    ...
    class InlineResponse20110Occurrences
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'occurrence_id')
          self.occurrence_id = attributes[:'occurrence_id']
        end
      ...
      def hash
        [occurrence_id, start_time, duration, status].hash
      end
