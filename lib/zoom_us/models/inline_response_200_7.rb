...
module ZoomUs
  module Models
    class InlineResponse2007
      ...
      # The number of records returned with a single API call. Default value: 30.
      ...
      def self.swagger_types
        {
          ...
          :'channels' => :'Array<InlineResponse2007Channels>'
        }
      end
      ...
      def hash
        [total_records, page_size, next_page_token, channels].hash
      end
