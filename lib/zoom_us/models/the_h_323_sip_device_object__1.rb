  ...
  module Models
    ...
    class TheH323SIPDeviceObject1
      ...
      def valid?
        ...
        protocol_validator = EnumAttributeValidator.new('String', ['H.323', 'SIP'])
        return false unless protocol_validator.valid?(@protocol)
        return false if @ip.nil?
        return false if @encryption.nil?
        encryption_validator = EnumAttributeValidator.new('String', ['auto', 'yes', 'no'])
      ...
      def protocol=(protocol)
        validator = EnumAttributeValidator.new('String', ['H.323', 'SIP'])
      ...
      def encryption=(encryption)
        validator = EnumAttributeValidator.new('String', ['auto', 'yes', 'no'])
      ...
      def hash
        [name, protocol, ip, encryption].hash
      end
