...
module ZoomUs
  module Models
    class InlineResponse20045
      ...
      def self.swagger_types
        {
          :'tsp_provider' => :'String',
          :'enable' => :'BOOLEAN',
          :'dial_in_numbers' => :'Array<InlineResponse20045DialInNumbers>',
          :'tsp_enabled' => :'BOOLEAN',
      ...
      def hash
        [tsp_provider, enable, dial_in_numbers, tsp_enabled, master_account_setting_extended, modify_credential_forbidden, dial_in_number_unrestricted, tsp_bridge].hash
      end
