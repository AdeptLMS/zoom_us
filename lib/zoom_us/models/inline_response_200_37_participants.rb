...
module ZoomUs
  module Models
    class InlineResponse20037Participants
      # Participant UUID.
      attr_accessor :id
      ...
      # Participant attentiveness score.
      attr_accessor :attentiveness_score
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'attentiveness_score')
          self.attentiveness_score = attributes[:'attentiveness_score']
        end
      end
      ...
      def hash
        [id, user_id, name, user_email, join_time, leave_time, duration, attentiveness_score].hash
      end
