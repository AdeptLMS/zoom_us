  ...
  module Models
    ...
    class InlineResponse20068
      ...
      def self.swagger_types
        {
          ...
          :'activity_logs' => :'Array<InlineResponse20068ActivityLogs>'
        }
      end
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'activity_logs')
          if (value = attributes[:'activity_logs']).is_a?(Array)
            self.activity_logs = value
          end
        end
      end
      ...
      def hash
        [from, to, page_size, next_page_token, activity_logs].hash
      end
