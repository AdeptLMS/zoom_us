...
module ZoomUs
  module Models
    class InlineResponse20074TrackingSources
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'registration_count')
          self.registration_count = attributes[:'registration_count']
        end

        if attributes.has_key?(:'visitor_count')
          self.visitor_count = attributes[:'visitor_count']
        end
      end
      ...
      def hash
        [id, source_name, tracking_url, registration_count, visitor_count].hash
      end
