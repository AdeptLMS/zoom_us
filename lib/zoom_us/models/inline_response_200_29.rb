  ...
  module Models
    class InlineResponse20029
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'webinars')
          if (value = attributes[:'webinars']).is_a?(Array)
            self.webinars = value
          end
        end
      end
      ...
      def hash
        [from, next_page_token, page_count, page_size, to, total_records, webinars].hash
      end
