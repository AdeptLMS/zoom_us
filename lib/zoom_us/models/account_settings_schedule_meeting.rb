...
module ZoomUs
  module Models
    ...
    class AccountSettingsScheduleMeeting
      ...
      def hash
        [host_video, participant_video, audio_type, join_before_host, enforce_login, enforce_login_with_domains, enforce_login_domains, not_store_meeting_topic, force_pmi_jbh_password, use_pmi_for_scheduled_meetings, use_pmi_for_instant_meetings, require_password_for_scheduling_new_meetings, require_password_for_scheduled_meetings, require_password_for_instant_meetings, require_password_for_pmi_meetings].hash
      end
