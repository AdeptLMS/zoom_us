...
module ZoomUs
  module Models
    class InlineResponse200100Invoices
      # Invoice number
      attr_accessor :invoice_number

      # Name of the invoice.
      attr_accessor :invoice_charge_name
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'invoice_charge_name')
          self.invoice_charge_name = attributes[:'invoice_charge_name']
        end
      ...
      def ==(o)
        ...
        self.class == o.class &&
          ...
          invoice_charge_name == o.invoice_charge_name &&
          quantity == o.quantity &&
      ...
      def hash
        [invoice_number, invoice_charge_name, quantity, total_amount, tax_amount, start_date, end_date].hash
      end
