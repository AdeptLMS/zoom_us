  ...
  module Models
    class InlineResponse20043
      ...
      def self.swagger_types
        {
          ...
          :'page_number' => :'Integer',
          :'page_size' => :'Integer',
          :'telephony_usage' => :'Array<InlineResponse20043TelephonyUsage>',
          :'to' => :'Date',
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'telephony_usage')
          if (value = attributes[:'telephony_usage']).is_a?(Array)
            self.telephony_usage = value
          end
        end
      ...
      def ==(o)
        ...
        self.class == o.class &&
          ...
          telephony_usage == o.telephony_usage &&
          to == o.to &&
      ...
      def hash
        [from, page_count, page_number, page_size, telephony_usage, to, total_records].hash
      end
