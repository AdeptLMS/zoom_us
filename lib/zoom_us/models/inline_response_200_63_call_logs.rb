...
module ZoomUs
  module Models
    class InlineResponse20063CallLogs
      # Call Log ID
      attr_accessor :id
      ...
      def hash
        [id, caller_number, caller_number_type, caller_name, callee_number, callee_number_type, callee_name, direction, duration, result, date_time].hash
      end
