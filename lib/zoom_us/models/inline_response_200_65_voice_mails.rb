...
module ZoomUs
  module Models
    class InlineResponse20065VoiceMails
      # Id of voice mail
      attr_accessor :id
      ...
      def valid?
        status_validator = EnumAttributeValidator.new('String', ['read', 'unread'])
      ...
      def status=(status)
        validator = EnumAttributeValidator.new('String', ['read', 'unread'])
      ...
      def hash
        [id, date_time, download_url, duration, caller_number, caller_number_type, caller_name, callee_number, callee_number_type, callee_name, status].hash
      end
