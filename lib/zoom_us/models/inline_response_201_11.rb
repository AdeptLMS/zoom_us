...
module ZoomUs
  module Models
    class InlineResponse20111
      ...
      # URL to join the meeting. If the meeting was [created](https://marketplace.zoom.us/docs/api-reference/zoom-api/meetings/meetingcreate) with manual approval type (`approval_type`: 1), the join URL will not be returned.
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'registrant_id')
      ...
      def hash
        [id, join_url, registrant_id, start_time, topic].hash
      end
