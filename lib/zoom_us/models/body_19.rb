  ...
  module Models
    class Body19
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'search_by_domain')
          self.search_by_domain = attributes[:'search_by_domain']
        end

        if attributes.has_key?(:'search_by_account')
          self.search_by_account = attributes[:'search_by_account']
        end

        if attributes.has_key?(:'search_by_ma_account')
          self.search_by_ma_account = attributes[:'search_by_ma_account']
        end
      end
      ...
      def valid?
        ...
        type_validator = EnumAttributeValidator.new('String', ['normal', 'shared', 'restricted'])
      ...
      def type=(type)
        validator = EnumAttributeValidator.new('String', ['normal', 'shared', 'restricted'])
      ...
      def ==(o)
        ...
        self.class == o.class &&
          name == o.name &&
          type == o.type &&
          search_by_domain == o.search_by_domain &&
          search_by_account == o.search_by_account &&
          search_by_ma_account == o.search_by_ma_account
      end
      ...
      def hash
        [name, type, search_by_domain, search_by_account, search_by_ma_account].hash
      end
