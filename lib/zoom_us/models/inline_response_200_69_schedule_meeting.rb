...
module ZoomUs
  module Models
    class InlineResponse20069ScheduleMeeting
      ...
      attr_accessor :upcoming_meeting_reminder
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'upcoming_meeting_reminder')
          self.upcoming_meeting_reminder = attributes[:'upcoming_meeting_reminder']
        end
      ...
      def ==(o)
        ...
        self.class == o.class &&
          ...
          upcoming_meeting_reminder == o.upcoming_meeting_reminder &&
      ...
      def hash
        [host_video, participant_video, audio_type, join_before_host, force_pmi_jbh_password, require_password_for_scheduling_new_meetings, require_password_for_instant_meetings, require_password_for_pmi_meetings, pstn_password_protected, mute_upon_entry, upcoming_meeting_reminder, meeting_authentication].hash
      end
