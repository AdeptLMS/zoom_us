...
module ZoomUs
  module Models
    class InlineResponse20110SettingsGlobalDialInNumbers
      ...
      def valid?
        type_validator = EnumAttributeValidator.new('String', ['toll', 'tollfree'])
      ...
      def hash
        [country, country_name, city, number, type].hash
      end
