...
module ZoomUs
  module Models
    class Body63
      ...
      # The MAC address of the desk phone.<br>  Note: If you're using a wireless phone, enter the wired MAC address, not the wireless MAC address.
      ...
      def list_invalid_properties
        ...
        if !@mac_address.nil? && @mac_address !~ Regexp.new(/^([0-9A-Fa-f]{2}[:-]?){5}([0-9A-Fa-f]{2})$/)
      ...
      def hash
        [display_name, mac_address, assigned_to].hash
      end
