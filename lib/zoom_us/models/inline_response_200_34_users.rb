...
module ZoomUs
  module Models
    class InlineResponse20034Users
      # User ID.
      attr_accessor :id
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'meeting_minutes')
          self.meeting_minutes = attributes[:'meeting_minutes']
        end
      end
      ...
      def ==(o)
        ...
        self.class == o.class &&
          ...
          meeting_minutes == o.meeting_minutes
      end
      ...
      def hash
        [id, email, user_name, type, dept, meetings, participants, meeting_minutes].hash
      end
