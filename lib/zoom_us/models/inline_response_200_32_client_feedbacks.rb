...
module ZoomUs
  module Models
    class InlineResponse20032ClientFeedbacks
      # Feedback Id
      attr_accessor :feedback_id

      # Feedback Name
      attr_accessor :feedback_name
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'feedback_id')
          self.feedback_id = attributes[:'feedback_id']
        end

        if attributes.has_key?(:'feedback_name')
          self.feedback_name = attributes[:'feedback_name']
        end
      ...
      def hash
        [feedback_id, feedback_name, participants_count].hash
      end
