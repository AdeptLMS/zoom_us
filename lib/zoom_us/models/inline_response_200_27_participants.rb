...
module ZoomUs
  module Models
    class InlineResponse20027Participants
      ...
      def hash
        [id, user_id, user_name, device, ip_address, location, network_type, microphone, speaker, data_center, connection_type, join_time, leave_time, share_application, share_desktop, share_whiteboard, recording, pc_name, domain, mac_addr, harddisk_id, version, in_room_participants, leave_reason].hash
      end
