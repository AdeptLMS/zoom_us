  ...
  module Models
    ...
    class QOSObject
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'avg_loss')
          self.avg_loss = attributes[:'avg_loss']
        end

        if attributes.has_key?(:'max_loss')
          self.max_loss = attributes[:'max_loss']
        end
      end
      ...
      def hash
        [bitrate, latency, jitter, avg_loss, max_loss].hash
      end
