...
module ZoomUs
  module Models
    class InlineResponse20025CustomQuestions
      ...
      def valid?
        type_validator = EnumAttributeValidator.new('String', ['short', 'single'])
      ...
      def type=(type)
        validator = EnumAttributeValidator.new('String', ['short', 'single'])
