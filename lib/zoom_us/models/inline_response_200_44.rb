  ...
  module Models
    class InlineResponse20044
      ...
      def self.swagger_types
        {
          ...
          :'operation_logs' => :'Array<InlineResponse20044OperationLogs>',
          :'page_size' => :'Integer'
        }
      end
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'operation_logs')
          if (value = attributes[:'operation_logs']).is_a?(Array)
            self.operation_logs = value
          end
        end
      ...
      def ==(o)
        ...
        self.class == o.class &&
          ...
          operation_logs == o.operation_logs &&
      ...
      def hash
        [next_page_token, operation_logs, page_size].hash
      end
