...
module ZoomUs
  module Models
    class RecordingRegistrantQuestionsCustomQuestions
      ...
      def valid?
        type_validator = EnumAttributeValidator.new('String', ['short', 'single', 'multiple'])
      ...
      def type=(type)
        validator = EnumAttributeValidator.new('String', ['short', 'single', 'multiple'])
