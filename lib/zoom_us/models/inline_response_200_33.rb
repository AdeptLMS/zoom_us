  ...
  module Models
    class InlineResponse20033
      ...
      def self.swagger_types
        {
          :'from' => :'Date',
          :'issue_details' => :'Array<InlineResponse20033IssueDetails>',
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'issue_details')
          if (value = attributes[:'issue_details']).is_a?(Array)
            self.issue_details = value
          end
        end
      ...
      def hash
        [from, issue_details, next_page_token, page_count, page_size, to, total_records].hash
      end
