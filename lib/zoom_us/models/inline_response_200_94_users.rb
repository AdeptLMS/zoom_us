...
module ZoomUs
  module Models
    class InlineResponse20094Users
      ...
      # Displays the status of the user's Zoom Phone license. The value can be either of the following:<br> `activate`: Active Zoom phone user.<br> `deactivate`: User with Zoom phone license disabled. This type of user can't make or receive calls.
      ...
      def hash
        [id, phone_user_id, name, email, site, extension_number, status].hash
      end
