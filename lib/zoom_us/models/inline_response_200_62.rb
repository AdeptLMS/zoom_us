  ...
  module Models
    ...
    class InlineResponse20062
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'outbound_caller')
          self.outbound_caller = attributes[:'outbound_caller']
        end
        ...
        if attributes.has_key?(:'company_number')
      ...
      def ==(o)
        ...
        self.class == o.class &&
          outbound_caller == o.outbound_caller &&
      ...
      def hash
        [outbound_caller, area_code, company_number].hash
      end
