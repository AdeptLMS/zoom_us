...
module ZoomUs
  module Models
    ...
    class CreateWebinarSettings
      ...
      def hash
        [host_video, panelists_video, practice_session, hd_video, approval_type, registration_type, audio, auto_recording, enforce_login, enforce_login_domains, alternative_hosts, close_registration, show_share_button, allow_multiple_devices, on_demand, global_dial_in_countries, contact_name, contact_email, registrants_restrict_number, post_webinar_survey, survey_url, registrants_email_notification, meeting_authentication, authentication_option, authentication_domains].hash
      end
