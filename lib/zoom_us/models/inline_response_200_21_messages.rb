...
module ZoomUs
  module Models
    class InlineResponse20021Messages
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'action_time')
          self.action_time = attributes[:'action_time']
        end
      end
      ...
      def hash
        [message, sender, date_time, action, action_time].hash
      end
