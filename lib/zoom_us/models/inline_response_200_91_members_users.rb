...
module ZoomUs
  module Models
    class InlineResponse20091MembersUsers
      ...
      def valid?
        level_validator = EnumAttributeValidator.new('String', ['manager', 'user'])
      ...
      def level=(level)
        validator = EnumAttributeValidator.new('String', ['manager', 'user'])
