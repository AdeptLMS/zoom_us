...
module ZoomUs
  module Models
    class InlineResponse20099BillingReports
      ...
      # Type of the billing report. The value should be either of the following:<br> `0` - Detailed Billing Reports `1` - Custom Billing Reports
      attr_accessor :type
      ...
      def hash
        [id, start_date, end_date, total_amount, tax_amount, type].hash
      end
