...
module ZoomUs
  module Models
    ...
    class InlineResponse20015PlanAudio
      # Additional audio conferencing <a href=\"/api-reference/other-references/plans\">plan type.</a>
      attr_accessor :type
      ...
      attr_accessor :tollfree_countries
      ...
      attr_accessor :premium_countries
      ...
      attr_accessor :callout_countries

      # Dedicated dial-In numbers.
      attr_accessor :ddi_numbers
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'tollfree_countries')
          self.tollfree_countries = attributes[:'tollfree_countries']
        end

        if attributes.has_key?(:'premium_countries')
          self.premium_countries = attributes[:'premium_countries']
        end

        if attributes.has_key?(:'callout_countries')
          self.callout_countries = attributes[:'callout_countries']
        end

        if attributes.has_key?(:'ddi_numbers')
          self.ddi_numbers = attributes[:'ddi_numbers']
        end
      end
      ...
      def ==(o)
        ...
        self.class == o.class &&
          type == o.type &&
          tollfree_countries == o.tollfree_countries &&
          premium_countries == o.premium_countries &&
          callout_countries == o.callout_countries &&
          ddi_numbers == o.ddi_numbers
      end
      ...
      def hash
        [type, tollfree_countries, premium_countries, callout_countries, ddi_numbers].hash
      end
