...
module ZoomUs
  module Models
    class InlineResponse20069InMeeting
      ...
      attr_accessor :show_browser_join_link
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'show_browser_join_link')
          self.show_browser_join_link = attributes[:'show_browser_join_link']
        end
      end
      ...
      def hash
        [e2e_encryption, chat, private_chat, auto_saving_chat, entry_exit_chime, file_transfer, feedback, post_meeting_feedback, co_host, polling, attendee_on_hold, show_meeting_control_toolbar, allow_show_zoom_windows, annotation, whiteboard, remote_control, non_verbal_feedback, breakout_room, remote_support, closed_caption, far_end_camera_control, group_hd, virtual_background, alert_guest_join, auto_answer, sending_default_email_invites, use_html_format_email, stereo_audio, original_audio, screen_sharing, attention_tracking, waiting_room, show_browser_join_link].hash
      end
