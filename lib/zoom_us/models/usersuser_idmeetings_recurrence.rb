...
module ZoomUs
  module Models
    # Recurrence object.
    class UsersuserIdmeetingsRecurrence
      ...
      # Days of the week the meeting should repeat.  Note: Multiple values should be separated by a comma. <br>`1`  - Sunday. <br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` -  Thursday.<br>`6` - Friday.<br>`7` - Saturday.
      ...
      # The week a meeting will recur each month.<br>`-1` - Last week.<br>`1` - First week.<br>`2` - Second week.<br>`3` - Third week.<br>`4` - Fourth week.
      attr_accessor :monthly_week

      # The weekday a meeting should recur each month.<br>`1` - Sunday.<br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` - Thursday.<br>`6` - Friday.<br>`7` - Saturday.
      ...
      def valid?
        weekly_days_validator = EnumAttributeValidator.new('String', ['1', '2', '3', '4', '5', '6', '7'])
        return false unless weekly_days_validator.valid?(@weekly_days)
        return false if !@end_times.nil? && @end_times > 50
        true
      end

      # Custom attribute writer method checking allowed values (enum).
      # @param [Object] weekly_days Object to be assigned
      def weekly_days=(weekly_days)
        validator = EnumAttributeValidator.new('String', ['1', '2', '3', '4', '5', '6', '7'])
        unless validator.valid?(weekly_days)
          fail ArgumentError, 'invalid value for "weekly_days", must be one of #{validator.allowable_values}.'
        end
        @weekly_days = weekly_days
      end
