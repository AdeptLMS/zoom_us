...
module ZoomUs
  module Models
    class InlineResponse20059
      attr_accessor :client_feedback_details
      ...
      def self.swagger_types
        {
          :'client_feedback_details' => :'Array<InlineResponse20059ClientFeedbackDetails>',
          :'from' => :'Date',
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'client_feedback_details')
          if (value = attributes[:'client_feedback_details']).is_a?(Array)
            self.client_feedback_details = value
          end
        end
      ...
      def ==(o)
        ...
        self.class == o.class &&
          client_feedback_details == o.client_feedback_details &&
          from == o.from &&
      ...
      def hash
        [client_feedback_details, from, next_page_token, page_size, to].hash
      end
