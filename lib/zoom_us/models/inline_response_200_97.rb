  ...
  module Models
    class InlineResponse20097
      ...
      def self.swagger_types
        {
          ...
          :'blocked_list' => :'Array<InlineResponse20097BlockedList>'
        }
      end
      ...
      def initialize(attributes = {})
        ...
        if attributes.has_key?(:'blocked_list')
          if (value = attributes[:'blocked_list']).is_a?(Array)
            self.blocked_list = value
          end
        end
      end
      ...
      def hash
        [next_page_token, page_size, total_records, blocked_list].hash
      end
