...
module ZoomUs
  module Models
    class WebianrRegistrant
      ...
      def hash
        [address, city, comments, country, custom_questions, email, first_name, industry, job_title, last_name, no_of_employees, org, phone, purchasing_time_frame, role_in_purchase_process, state, zip].hash
      end
