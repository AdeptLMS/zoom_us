...
# Unit tests for ZoomUs::AccountSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountSettings' do
  before do
    # run before each test
    @instance = ZoomUs::AccountSettings.new
  end
  ...
  describe 'test an instance of AccountSettings' do
    it 'should create an instance of AccountSettings' do
      expect(@instance).to be_instance_of(ZoomUs::AccountSettings)
    end
  end
  describe 'test attribute "schedule_meting"' do
    it 'should work' do
  ...
  describe 'test attribute "zoom_rooms"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
