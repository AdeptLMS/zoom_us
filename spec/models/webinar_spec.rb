...
# Unit tests for ZoomUs::Webinar
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Webinar' do
  before do
    # run before each test
    @instance = ZoomUs::Webinar.new
  end
  ...
  describe 'test an instance of Webinar' do
    it 'should create an instance of Webinar' do
      expect(@instance).to be_instance_of(ZoomUs::Webinar)
    end
  end
