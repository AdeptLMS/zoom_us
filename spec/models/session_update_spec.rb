...
# Unit tests for ZoomUs::SessionUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SessionUpdate' do
  before do
    # run before each test
    @instance = ZoomUs::SessionUpdate.new
  end
  ...
  describe 'test an instance of SessionUpdate' do
    it 'should create an instance of SessionUpdate' do
      expect(@instance).to be_instance_of(ZoomUs::SessionUpdate)
    end
  end
