...
# Unit tests for ZoomUs::GroupList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupList' do
  before do
    # run before each test
    @instance = ZoomUs::GroupList.new
  end
  ...
  describe 'test an instance of GroupList' do
    it 'should create an instance of GroupList' do
      expect(@instance).to be_instance_of(ZoomUs::GroupList)
    end
  end
