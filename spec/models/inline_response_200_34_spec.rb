...
# Unit tests for ZoomUs::InlineResponse20034
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20034' do
  before do
    # run before each test
    @instance = ZoomUs::InlineResponse20034.new
  end
  ...
  describe 'test an instance of InlineResponse20034' do
    it 'should create an instance of InlineResponse20034' do
      expect(@instance).to be_instance_of(ZoomUs::InlineResponse20034)
    end
  end
  ...
  describe 'test attribute "total_meeting_minutes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "total_meetings"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
