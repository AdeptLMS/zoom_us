...
# Unit tests for ZoomUs::AccountOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountOptions' do
  before do
    # run before each test
    @instance = ZoomUs::AccountOptions.new
  end
  ...
  describe 'test an instance of AccountOptions' do
    it 'should create an instance of AccountOptions' do
      expect(@instance).to be_instance_of(ZoomUs::AccountOptions)
    end
  end
